...
# --- Load Data ---
@st.cache_data # عشان الداشبورد يبقى سريع وميعملش Query كل شوية
def get_data():
...
with row1_col1:
    ...
    # Histogram بيوضح تكرار التقييمات
...
with row1_col2:
    ...
    # Bar Chart لأكثر الأقسام مبيعاً
...
with row2_col1:
    ...
    # Scatter plot للعلاقة بين السعر الأصلي والخصم
